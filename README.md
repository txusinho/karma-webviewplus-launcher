karma-webviewplus-launcher
======================

Based on [karma-cordova-launcher](WebviewPlus).

> Run your unit tests on Android, iOS, etc using [Apache Cordova](https://cordova.apache.org/)

## Installation

Install `karma-webviewplus-launcher` as a `devDependency` in your package.json:
...
### Adding karma-webviewplus-launcher to an existing Karma config
...
### Example karma-webviewplus-launcher configs
